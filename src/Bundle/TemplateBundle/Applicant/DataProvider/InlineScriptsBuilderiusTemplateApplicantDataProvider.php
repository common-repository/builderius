...
class InlineScriptsBuilderiusTemplateApplicantDataProvider implements BuilderiusTemplateApplicantDataProviderInterface
{
    /**
    ...
    public function getData(array $applicantQueryVars = [])
    {
        ...
        if (is_array($cachedInlineAssets) && isset($cachedInlineAssets['scripts'])) {
            return $cachedInlineAssets['scripts'];
        }
