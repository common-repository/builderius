...
class BuilderiusTemplateAllBlogPostsApplicantsProvider extends AbstractBuilderiusTemplateSingularApplicantsProvider
{
    /**
     * @var \WP_Query
     */
    ...
    {
        if (
            strpos($rule, 'singular.single.blog_post.all') !== false &&
            $argument === true &&
            $operator === '=='
        ) {
            return true;
