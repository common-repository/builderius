...
class BuilderiusTemplateAllPagesApplicantsProvider extends AbstractBuilderiusTemplateSingularApplicantsProvider
{
    /**
     * @var \WP_Query
     */
    ...
    {
        if (strpos($rule, 'singular.page.all') !== false && $argument === true && $operator === '==') {
            return true;
        }
