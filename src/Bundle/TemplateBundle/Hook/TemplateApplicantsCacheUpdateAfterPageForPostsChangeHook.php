...
class TemplateApplicantsCacheUpdateAfterPageForPostsChangeHook extends AbstractTemplateApplicantsCacheUpdateHook
{
    /**
     * @inheritDoc
     */
    public function getFunction()
    {
        ...
        if ($optionName === 'page_for_posts' && $oldValue !== $newValue) {
            ...
            if (false !== $cache && is_array($cache)) {
                if ('page' === get_option('show_on_front')) {
                    ...
                    $k = sprintf('singular.single.page.%s', $newValue);
