...
use Builderius\Symfony\Component\VarExporter\Exception\ClassNotFoundException;
...
class Registry
{
    ...
    public static function getClassReflector($class, $instantiableWithoutConstructor = \false, $cloneable = null)
    {
        if (!($isClass = \class_exists($class)) && !\interface_exists($class, \false) && !\trait_exists($class, \false)) {
            throw new \Builderius\Symfony\Component\VarExporter\Exception\ClassNotFoundException($class);
        }
        ...
        if ($instantiableWithoutConstructor) {
            ...
            if (null !== $proto && !$proto instanceof \Throwable && !$proto instanceof \Serializable && !\method_exists($class, '__sleep') && (\PHP_VERSION_ID < 70400 || !\method_exists($class, '__serialize'))) {
                try {
                    ...
                    throw new \Builderius\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException($class, $e);
                }
            }
        }
        if (null === $cloneable) {
