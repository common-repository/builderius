 ...
 */
namespace Builderius\Symfony\Component\VarExporter;

use Builderius\Symfony\Component\VarExporter\Exception\ExceptionInterface;
use Builderius\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException;
use Builderius\Symfony\Component\VarExporter\Internal\Hydrator;
use Builderius\Symfony\Component\VarExporter\Internal\Registry;
/**
...
final class Instantiator
{
    ...
    public static function instantiate(string $class, array $properties = [], array $privateProperties = []) : object
    {
        ...
        if (\Builderius\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = [clone \Builderius\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]];
        } elseif (\Builderius\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = [$reflector->newInstanceWithoutConstructor()];
        } elseif (null === \Builderius\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
            throw new \Builderius\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException($class);
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (\Builderius\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] ?? \Builderius\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
