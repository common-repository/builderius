 ...
 * @internal
 */
class BinaryNode extends \Builderius\Symfony\Component\ExpressionLanguage\Node\Node
{
    private static $operators = ['~' => '.', 'and' => '&&', 'or' => '||'];
    private static $functions = ['**' => 'pow', '..' => 'range', 'in' => 'in_array', 'not in' => '!in_array'];
    public function __construct(string $operator, \Builderius\Symfony\Component\ExpressionLanguage\Node\Node $left, \Builderius\Symfony\Component\ExpressionLanguage\Node\Node $right)
    {
