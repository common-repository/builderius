 ...
 * @internal
 */
class GetAttrNode extends \Builderius\Symfony\Component\ExpressionLanguage\Node\Node
{
    const PROPERTY_CALL = 1;
    const METHOD_CALL = 2;
    const ARRAY_CALL = 3;
    public function __construct(\Builderius\Symfony\Component\ExpressionLanguage\Node\Node $node, \Builderius\Symfony\Component\ExpressionLanguage\Node\Node $attribute, \Builderius\Symfony\Component\ExpressionLanguage\Node\ArrayNode $arguments, int $type)
    {
