 ...
 */
namespace Builderius\Symfony\Component\Config\Resource;

use Builderius\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use Builderius\Symfony\Component\Messenger\Handler\MessageSubscriberInterface;
 ...
 * @final
 */
class ReflectionClassResource implements \Builderius\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $files = [];
    private $className;
    ...
    private function generateSignature(\ReflectionClass $class) : iterable
    {
        ...
        if (\interface_exists(\Builderius\Symfony\Component\EventDispatcher\EventSubscriberInterface::class, \false) && $class->isSubclassOf(\Builderius\Symfony\Component\EventDispatcher\EventSubscriberInterface::class)) {
            (yield \Builderius\Symfony\Component\EventDispatcher\EventSubscriberInterface::class);
            (yield \print_r($class->name::getSubscribedEvents(), \true));
        }
        if (\interface_exists(\Builderius\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class, \false) && $class->isSubclassOf(\Builderius\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class)) {
            (yield \Builderius\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class);
            foreach ($class->name::getHandledMessages() as $key => $value) {
                (yield $key . \print_r($value, \true));
            }
        }
        if (\interface_exists(\Builderius\Symfony\Contracts\Service\ServiceSubscriberInterface::class, \false) && $class->isSubclassOf(\Builderius\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            (yield \Builderius\Symfony\Contracts\Service\ServiceSubscriberInterface::class);
