 ...
 */
class LoaderResolver implements \Builderius\Symfony\Component\Config\Loader\LoaderResolverInterface
{
    /**
    ...
    public function addLoader(\Builderius\Symfony\Component\Config\Loader\LoaderInterface $loader)
    {
        $this->loaders[] = $loader;
