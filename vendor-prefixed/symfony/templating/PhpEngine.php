...
use Builderius\Symfony\Component\Templating\Helper\HelperInterface;
use Builderius\Symfony\Component\Templating\Loader\LoaderInterface;
...
use Builderius\Symfony\Component\Templating\Storage\StringStorage;
/**
 * PhpEngine is an engine able to render PHP templates.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class PhpEngine implements \Builderius\Symfony\Component\Templating\EngineInterface, \ArrayAccess
{
    protected $loader;
    protected $current;
    /**
     ...
     */
    public function __construct(\Builderius\Symfony\Component\Templating\TemplateNameParserInterface $parser, \Builderius\Symfony\Component\Templating\Loader\LoaderInterface $loader, array $helpers = [])
    {
        $this->parser = $parser;
        $this->loader = $loader;
     ...
     */
    protected function evaluate(\Builderius\Symfony\Component\Templating\Storage\Storage $template, array $parameters = [])
    {
        ...
        $view = $this;
        if ($this->evalTemplate instanceof \Builderius\Symfony\Component\Templating\Storage\FileStorage) {
            ...
            return \ob_get_clean();
        } elseif ($this->evalTemplate instanceof \Builderius\Symfony\Component\Templating\Storage\StringStorage) {
            \extract($this->evalParameters, \EXTR_SKIP);
            $this->evalParameters = null;
            \ob_start();
    ...
    public function set(\Builderius\Symfony\Component\Templating\Helper\HelperInterface $helper, string $alias = null)
    {
    ...
    protected function initializeEscapers()
    {
        ...
        $this->escapers = ['html' => function ($value) use($flags) {
