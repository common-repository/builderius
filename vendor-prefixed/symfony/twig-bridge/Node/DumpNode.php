 ...
 */
final class DumpNode extends \Builderius\Twig\Node\Node
{
    private $varPrefix;
    public function __construct($varPrefix, ?\Builderius\Twig\Node\Node $values, int $lineno, string $tag = null)
    {
        $nodes = [];
        if (null !== $values) {
            $nodes['values'] = $values;
