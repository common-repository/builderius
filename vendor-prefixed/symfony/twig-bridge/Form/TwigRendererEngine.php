 ...
 */
namespace Builderius\Symfony\Bridge\Twig\Form;

use Builderius\Symfony\Component\Form\AbstractRendererEngine;
 ...
 */
class TwigRendererEngine extends \Builderius\Symfony\Component\Form\AbstractRendererEngine
{
    /**
     * @var Environment
     */
     ...
     */
    private $template;
    public function __construct(array $defaultThemes, \Builderius\Twig\Environment $environment)
    {
     ...
     * {@inheritdoc}
     */
    public function renderBlock(\Builderius\Symfony\Component\Form\FormView $view, $resource, string $blockName, array $variables = [])
    {
     ...
     */
    protected function loadResourceForBlockName(string $cacheKey, \Builderius\Symfony\Component\Form\FormView $view, string $blockName)
    {
    ...
    {
        if (!$theme instanceof \Builderius\Twig\Template) {
            /* @var Template $theme */
