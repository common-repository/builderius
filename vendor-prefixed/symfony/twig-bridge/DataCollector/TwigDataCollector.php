 ...
 */
namespace Builderius\Symfony\Bridge\Twig\DataCollector;

use Builderius\Symfony\Component\HttpFoundation\Request;
use Builderius\Symfony\Component\HttpFoundation\Response;
use Builderius\Symfony\Component\HttpKernel\DataCollector\DataCollector;
use Builderius\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface;
use Builderius\Twig\Environment;
use Builderius\Twig\Error\LoaderError;
use Builderius\Twig\Markup;
use Builderius\Twig\Profiler\Dumper\HtmlDumper;
 ...
 * @final
 */
class TwigDataCollector extends \Builderius\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \Builderius\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    private $profile;
    private $twig;
    private $computed;
    public function __construct(\Builderius\Twig\Profiler\Profile $profile, \Builderius\Twig\Environment $twig = null)
    {
     ...
     * {@inheritdoc}
     */
    public function collect(\Builderius\Symfony\Component\HttpFoundation\Request $request, \Builderius\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
    }
    /**
     * {@inheritdoc}
    ...
    public function lateCollect()
    {
        ...
        $templateFinder = function (\Builderius\Twig\Profiler\Profile $profile) use(&$templateFinder) {
    ...
    {
        $dumper = new \Builderius\Twig\Profiler\Dumper\HtmlDumper();
        ...
        return new \Builderius\Twig\Markup($dump, 'UTF-8');
    }
    public function getProfile()
    {
        if (null === $this->profile) {
            $this->profile = \unserialize($this->data['profile'], ['allowed_classes' => ['Twig_Profiler_Profile', 'Builderius\\Twig\\Profiler\\Profile']]);
        }
        return $this->profile;
    }
    ...
    private function computeData(\Builderius\Twig\Profiler\Profile $profile)
    {
