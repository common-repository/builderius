 ...
 */
final class CodeExtension extends \Builderius\Twig\Extension\AbstractExtension
{
    ...
    {
        return [new \Builderius\Twig\TwigFilter('abbr_class', [$this, 'abbrClass'], ['is_safe' => ['html']]), new \Builderius\Twig\TwigFilter('abbr_method', [$this, 'abbrMethod'], ['is_safe' => ['html']]), new \Builderius\Twig\TwigFilter('format_args', [$this, 'formatArgs'], ['is_safe' => ['html']]), new \Builderius\Twig\TwigFilter('format_args_as_text', [$this, 'formatArgsAsText']), new \Builderius\Twig\TwigFilter('file_excerpt', [$this, 'fileExcerpt'], ['is_safe' => ['html']]), new \Builderius\Twig\TwigFilter('format_file', [$this, 'formatFile'], ['is_safe' => ['html']]), new \Builderius\Twig\TwigFilter('format_file_from_text', [$this, 'formatFileFromText'], ['is_safe' => ['html']]), new \Builderius\Twig\TwigFilter('format_log_message', [$this, 'formatLogMessage'], ['is_safe' => ['html']]), new \Builderius\Twig\TwigFilter('file_link', [$this, 'getFileLink']), new \Builderius\Twig\TwigFilter('file_relative', [$this, 'getFileRelative'])];
    }
    ...
    public function formatArgs(array $args) : string
    {
        ...
        foreach ($args as $key => $item) {
            if ('object' === $item[0]) {
                ...
                $formattedValue = \str_replace("\n", '', \htmlspecialchars(\var_export($item[1], \true), \ENT_COMPAT | \ENT_SUBSTITUTE, $this->charset));
            }
