...
use Builderius\Symfony\Component\String\Exception\ExceptionInterface;
use Builderius\Symfony\Component\String\Exception\InvalidArgumentException;
/**
 ...
 * @experimental in 5.0
 */
class UnicodeString extends \Builderius\Symfony\Component\String\AbstractUnicodeString
{
    public function __construct(string $string = '')
    {
        $this->string = \normalizer_is_normalized($string) ? $string : \normalizer_normalize($string);
        if (\false === $this->string) {
            throw new \Builderius\Symfony\Component\String\Exception\InvalidArgumentException('Invalid UTF-8 string.');
        }
    }
    public function append(string ...$suffix) : \Builderius\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    {
        if (1 > $length) {
            throw new \Builderius\Symfony\Component\String\Exception\InvalidArgumentException('The chunk length must be greater than zero.');
        }
        if ('' === $this->string) {
            return [];
        }
    ...
    {
        if ($suffix instanceof \Builderius\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \Builderius\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($needle instanceof \Builderius\Symfony\Component\String\AbstractString) {
    ...
    public function join(array $strings, string $lastGlue = null) : \Builderius\Symfony\Component\String\AbstractString
    {
    ...
    public function normalize(int $form = self::NFC) : parent
    {
        ...
        if (\in_array($form, [self::NFC, self::NFKC], \true)) {
            ...
            throw new \Builderius\Symfony\Component\String\Exception\InvalidArgumentException('Unsupported normalization form.');
    ...
    public function prepend(string ...$prefix) : \Builderius\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replace(string $from, string $to) : \Builderius\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replaceMatches(string $fromRegexp, $to) : \Builderius\Symfony\Component\String\AbstractString
    {
        $str = parent::replaceMatches($fromRegexp, $to);
        \normalizer_is_normalized($str->string) ?: ($str->string = \normalizer_normalize($str->string));
        return $str;
    }
    public function slice(int $start = 0, int $length = null) : \Builderius\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
        $str->string = (string) \grapheme_substr($this->string, $start, $length ?? \PHP_INT_MAX);
        return $str;
    }
    public function splice(string $replacement, int $start = 0, int $length = null) : \Builderius\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        if (1 > ($limit = $limit ?? \PHP_INT_MAX)) {
            throw new \Builderius\Symfony\Component\String\Exception\InvalidArgumentException('Split limit must be a positive integer.');
        }
        if ('' === $delimiter) {
            throw new \Builderius\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is empty.');
        }
        if (null !== $flags) {
        ...
        if (\false === $delimiter) {
            throw new \Builderius\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
        $tail = $this->string;
        $chunks = [];
    ...
    {
        if ($prefix instanceof \Builderius\Symfony\Component\String\AbstractString) {
