 ...
 */
class PrototypeConfigurator extends \Builderius\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    const FACTORY = 'load';
    ...
    private $excludes;
    private $allowParent;
    public function __construct(\Builderius\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, \Builderius\Symfony\Component\DependencyInjection\Loader\PhpFileLoader $loader, \Builderius\Symfony\Component\DependencyInjection\Definition $defaults, string $namespace, string $resource, bool $allowParent)
    {
