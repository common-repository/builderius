...
if (\interface_exists(\Builderius\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \Builderius\Psr\Cache\CacheException, \Builderius\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \Builderius\Psr\Cache\CacheException
    {
    }
}
