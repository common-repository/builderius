 ...
 */
namespace Builderius\Symfony\Component\Cache\Marshaller;
 ...
 */
class DefaultMarshaller implements \Builderius\Symfony\Component\Cache\Marshaller\MarshallerInterface
{
    ...
    public function __construct(bool $useIgbinarySerialize = null)
    {
        if (null === $useIgbinarySerialize) {
            ...
            throw new \Builderius\Symfony\Component\Cache\Exception\CacheException(\extension_loaded('igbinary') && \PHP_VERSION_ID >= 70400 ? 'Please upgrade the "igbinary" PHP extension to v3.1 or higher.' : 'The "igbinary" PHP extension is not loaded.');
        }
