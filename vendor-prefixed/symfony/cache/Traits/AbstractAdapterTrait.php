...
use Builderius\Psr\Log\LoggerAwareTrait;
...
trait AbstractAdapterTrait
{
    ...
    public function hasItem($key)
    {
        ...
        try {
            ...
            \Builderius\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to check if key "{key}" is cached: ' . $e->getMessage(), ['key' => $key, 'exception' => $e]);
            return \false;
        }
    }
    /**
    ...
    public function clear(string $prefix = '')
    {
        ...
        try {
            ...
            \Builderius\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to clear the cache: ' . $e->getMessage(), ['exception' => $e]);
            return \false;
        }
    }
    /**
    ...
    public function deleteItems(array $keys)
    {
        ...
        foreach ($ids as $key => $id) {
            ...
            \Builderius\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['key' => $key, 'exception' => $e]);
            $ok = \false;
        }
        return $ok;
    }
    ...
    public function getItem($key)
    {
        ...
        try {
            ...
            \Builderius\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch key "{key}": ' . $e->getMessage(), ['key' => $key, 'exception' => $e]);
        }
    ...
    public function getItems(array $keys = [])
    {
        ...
        try {
            ...
            \Builderius\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch items: ' . $e->getMessage(), ['keys' => $keys, 'exception' => $e]);
            $items = [];
        }
    ...
    private function generateItems(iterable $items, array &$keys) : iterable
    {
        ...
        try {
            ...
            \Builderius\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch items: ' . $e->getMessage(), ['keys' => \array_values($keys), 'exception' => $e]);
        }
        foreach ($keys as $key) {
