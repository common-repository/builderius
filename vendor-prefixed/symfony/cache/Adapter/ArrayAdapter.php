 ...
 */
class ArrayAdapter implements \Builderius\Symfony\Component\Cache\Adapter\AdapterInterface, \Builderius\Symfony\Contracts\Cache\CacheInterface, \Builderius\Psr\Log\LoggerAwareInterface, \Builderius\Symfony\Component\Cache\ResettableInterface
{
    ...
    private function unfreeze(string $key, bool &$isHit)
    {
        ...
        if (\is_string($value) && isset($value[2]) && ':' === $value[1]) {
            try {
                ...
                \Builderius\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to unserialize key "{key}": ' . $e->getMessage(), ['key' => $key, 'exception' => $e]);
                $value = \false;
            }
            if (\false === $value) {
                $this->values[$key] = $value = null;
