 ...
 */
class ApcuAdapter extends \Builderius\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    /**
    ...
    public function __construct(string $namespace = '', int $defaultLifetime = 0, string $version = null)
    {
        if (!static::isSupported()) {
            throw new \Builderius\Symfony\Component\Cache\Exception\CacheException('APCu is not enabled.');
        }
        if ('cli' === \PHP_SAPI) {
        ...
        if (null !== $version) {
            \Builderius\Symfony\Component\Cache\CacheItem::validateKey($version);
