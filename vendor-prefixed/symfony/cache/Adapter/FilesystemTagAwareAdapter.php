 ...
 */
class FilesystemTagAwareAdapter extends \Builderius\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter implements \Builderius\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait {
    ...
    {
        $this->marshaller = new \Builderius\Symfony\Component\Cache\Marshaller\TagAwareMarshaller($marshaller);
