 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \Builderius\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \Builderius\Symfony\Contracts\Cache\TagAwareCacheInterface, \Builderius\Psr\Log\LoggerAwareInterface, \Builderius\Symfony\Component\Cache\ResettableInterface
{
    ...
    protected function __construct(string $namespace = '', int $defaultLifetime = 0)
    {
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) {
            ...
            $item->metadata[\Builderius\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix, $defaultLifetime) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\Builderius\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\Builderius\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\Builderius\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
