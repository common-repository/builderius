...
class SchemaConfig
{
    ...
    public static function create(array $options = [])
    {
        ...
        if (\count($options) > 0) {
            ...
            if (isset($options['typeLoader'])) {
                \Builderius\GraphQL\Utils\Utils::invariant(\is_callable($options['typeLoader']), 'Schema type loader must be callable if provided but got: %s', \Builderius\GraphQL\Utils\Utils::printSafe($options['typeLoader']));
     ...
     * @return SchemaConfig
     */
    public function setAstNode(\Builderius\GraphQL\Language\AST\SchemaDefinitionNode $astNode)
    {
