...
class IDType extends \Builderius\GraphQL\Type\Definition\ScalarType
{
    /** @var string */
    public $name = 'ID';
    /** @var string */
...
(such as `4`) input value will be accepted as an ID.';
    ...
    {
        $canCast = \is_string($value) || \is_int($value) || \is_object($value) && \method_exists($value, '__toString');
        if (!$canCast) {
            throw new \Builderius\GraphQL\Error\Error('ID cannot represent value: ' . \Builderius\GraphQL\Utils\Utils::printSafe($value));
        }
        return (string) $value;
    }
    /**
    ...
    {
        if ($valueNode instanceof \Builderius\GraphQL\Language\AST\StringValueNode || $valueNode instanceof \Builderius\GraphQL\Language\AST\IntValueNode) {
