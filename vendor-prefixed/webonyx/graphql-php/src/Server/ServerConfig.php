...
class ServerConfig
{
    ...
    public static function create(array $config = [])
    {
        ...
        foreach ($config as $key => $value) {
            ...
            if (!\method_exists($instance, $method)) {
                throw new \Builderius\GraphQL\Error\InvariantViolation(\sprintf('Unknown server config option "%s"', $key));
            }
    ...
    /** @var int */
    private $debugFlag = \Builderius\GraphQL\Error\DebugFlag::NONE;
    /** @var bool */
     ...
     * @api
     */
    public function setSchema(\Builderius\GraphQL\Type\Schema $schema)
    {
        $this->schema = $schema;
        return $this;
    }
    ...
    public function setValidationRules($validationRules)
    {
        if (!\is_callable($validationRules) && !\is_array($validationRules) && $validationRules !== null) {
            throw new \Builderius\GraphQL\Error\InvariantViolation('Server config expects array of validation rules or callable returning such array, but got ' . \Builderius\GraphQL\Utils\Utils::printSafe($validationRules));
        }
     ...
     * @api
     */
    public function setDebugFlag(int $debugFlag = \Builderius\GraphQL\Error\DebugFlag::INCLUDE_DEBUG_MESSAGE) : self
    {
     ...
     * @api
     */
    public function setPromiseAdapter(\Builderius\GraphQL\Executor\Promise\PromiseAdapter $promiseAdapter)
    {
