...
class MixedStore implements \ArrayAccess
{
    ...
    public function offsetSet($offset, $value)
    {
        if ($offset === \false) {
            ...
            $this->falseValueIsSet = \true;
        } elseif ($offset === \true) {
            $this->trueValue = $value;
            $this->trueValueIsSet = \true;
            ...
            $this->nullValueIsSet = \true;
        } else {
            throw new \InvalidArgumentException('Unexpected offset type: ' . \Builderius\GraphQL\Utils\Utils::printSafe($offset));
        }
    }
    /**
     * Offset to unset
    ...
    public function offsetUnset($offset)
    {
        if ($offset === \true) {
            ...
            $index = \array_search($offset, $this->arrayKeys, \true);
            if ($index !== \false) {
