...
class ExecutionResult implements \JsonSerializable
{
     ...
     * @api
     */
    public function toArray(int $debug = \Builderius\GraphQL\Error\DebugFlag::NONE) : array
    {
        $result = [];
        if (\count($this->errors ?? []) > 0) {
            ...
            $result['errors'] = $errorsHandler($this->errors, \Builderius\GraphQL\Error\FormattedError::prepareFormatter($this->errorFormatter, $debug));
        }
        if ($this->data !== null) {
