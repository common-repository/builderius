...
use Builderius\GraphQL\Exception\InvalidArgument;
use function is_int;
...
final class Warning
{
     ...
     * @api
     */
    public static function suppress($suppress = \true) : void
    {
        if ($suppress === \true) {
            ...
            throw \Builderius\GraphQL\Exception\InvalidArgument::fromExpectedTypeAndArgument('bool|int', $suppress);
        }
    }
    /**
     ...
     * @api
     */
    public static function enable($enable = \true) : void
    {
        if ($enable === \true) {
            self::$enableWarnings = self::ALL;
        } elseif ($enable === \false) {
            ...
            throw \Builderius\GraphQL\Exception\InvalidArgument::fromExpectedTypeAndArgument('bool|int', $enable);
        }
    }
