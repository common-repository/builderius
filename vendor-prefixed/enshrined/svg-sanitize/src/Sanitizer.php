...
namespace Builderius\enshrined\svgSanitize;

use Builderius\enshrined\svgSanitize\data\AllowedAttributes;
use Builderius\enshrined\svgSanitize\data\AllowedTags;
use Builderius\enshrined\svgSanitize\data\AttributeInterface;
use Builderius\enshrined\svgSanitize\data\TagInterface;
use Builderius\enshrined\svgSanitize\data\XPath;
use Builderius\enshrined\svgSanitize\ElementReference\Resolver;
/**
 * Class Sanitizer
 *
...
class Sanitizer
{
    ...
    function __construct()
    {
        ...
        $this->allowedAttrs = \array_map('strtolower', \Builderius\enshrined\svgSanitize\data\AllowedAttributes::getAttributes());
        $this->allowedTags = \array_map('strtolower', \Builderius\enshrined\svgSanitize\data\AllowedTags::getTags());
    }
    /**
     ...
     */
    public function setAllowedTags(\Builderius\enshrined\svgSanitize\data\TagInterface $allowedTags)
    {
     ...
     */
    public function setAllowedAttrs(\Builderius\enshrined\svgSanitize\data\AttributeInterface $allowedAttrs)
    {
    ...
    public function sanitize($dirty)
    {
        ...
        $xPath = new \Builderius\enshrined\svgSanitize\data\XPath($this->xmlDocument);
        $this->elementReferenceResolver = new \Builderius\enshrined\svgSanitize\ElementReference\Resolver($xPath, $this->useNestingLimit);
    ...
    {
        $href = \Builderius\enshrined\svgSanitize\Helper::getElementHref($element);
    ...
    protected function isUseTagExceedingThreshold(\DOMElement $element)
    {
        ...
        $useId = \Builderius\enshrined\svgSanitize\Helper::extractIdReferenceFromHref(\Builderius\enshrined\svgSanitize\Helper::getElementHref($element));
        if ($useId === null) {
            return \false;
        }
