...
final class Installer implements \Builderius\PackageVersions\ComposerV2Plugin, \Composer\EventDispatcher\EventSubscriberInterface
{
...
PHP;
     ...
     */
    public static function dumpVersionsClass(\Composer\Script\Event $composerEvent) : void
    {
     ...
     * @throws RuntimeException
     */
    private static function writeVersionClassToFile(string $versionClassSource, \Composer\Composer $composer, \Composer\IO\IOInterface $io) : void
    {
        ...
        if (!\is_writable($installDir)) {
            $io->write(\sprintf('<info>ocramius/package-versions:</info> %s is not writable; generation of version class skipped.', $installDir));
            return;
        }
