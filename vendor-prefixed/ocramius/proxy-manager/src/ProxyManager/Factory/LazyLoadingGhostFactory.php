...
use Builderius\ProxyManager\ProxyGenerator\LazyLoadingGhostGenerator;
 ...
 * @license MIT
 */
class LazyLoadingGhostFactory extends \Builderius\ProxyManager\Factory\AbstractBaseFactory
{
    /**
     * @var \Builderius\ProxyManager\ProxyGenerator\LazyLoadingGhostGenerator|null
     */
    private $generator;
    /**
     * {@inheritDoc}
    ...
    {
        return $this->generator ?: ($this->generator = new \Builderius\ProxyManager\ProxyGenerator\LazyLoadingGhostGenerator());
    }
    /**
     ...
     */
    public function createProxy(string $className, \Closure $initializer, array $proxyOptions = []) : \Builderius\ProxyManager\Proxy\GhostObjectInterface
    {
