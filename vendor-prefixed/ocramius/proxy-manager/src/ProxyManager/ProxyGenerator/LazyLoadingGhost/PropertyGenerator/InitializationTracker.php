 ...
 * @license MIT
 */
class InitializationTracker extends \Builderius\Zend\Code\Generator\PropertyGenerator
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct(\Builderius\ProxyManager\Generator\Util\IdentifierSuffixer::getIdentifier('initializationTracker'));
