...
class PublicScopeSimulator
{
     ...
     */
    public static function getPublicAccessSimulationCode(string $operationType, string $nameParameter, $valueParameter = null, \Builderius\Zend\Code\Generator\PropertyGenerator $valueHolder = null, $returnPropertyName = null) : string
    {
     ...
     * @return string
     */
    private static function getTargetObject(\Builderius\Zend\Code\Generator\PropertyGenerator $valueHolder = null) : string
    {
        if ($valueHolder) {
