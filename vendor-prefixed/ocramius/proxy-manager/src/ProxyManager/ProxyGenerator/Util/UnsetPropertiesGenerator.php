...
namespace Builderius\ProxyManager\ProxyGenerator\Util;
...
PHP;
    public static function generateSnippet(\Builderius\ProxyManager\ProxyGenerator\Util\Properties $properties, string $instanceName) : string
    {
    ...
    private static function generateUnsetAccessiblePropertiesCode(\Builderius\ProxyManager\ProxyGenerator\Util\Properties $properties, string $instanceName) : string
    {
    ...
    private static function generateUnsetPrivatePropertiesCode(\Builderius\ProxyManager\ProxyGenerator\Util\Properties $properties, string $instanceName) : string
    {
    ...
    private static function generateUnsetClassPrivatePropertiesBlock(\ReflectionClass $declaringClass, array $properties, string $instanceName) : string
    {
        $declaringClassName = $declaringClass->getName();
        return \sprintf(self::$closureTemplate, $declaringClassName, self::generateUnsetStatement($properties, 'instance'), $instanceName, \var_export($declaringClassName, \true), $instanceName);
    }
    private static function generateUnsetStatement(array $properties, string $instanceName) : string
    {
        return 'unset(' . \implode(', ', \array_map(function (\ReflectionProperty $property) use($instanceName) : string {
