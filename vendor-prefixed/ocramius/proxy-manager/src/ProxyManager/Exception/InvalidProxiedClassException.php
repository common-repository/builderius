 ...
 * @license MIT
 */
class InvalidProxiedClassException extends \InvalidArgumentException implements \Builderius\ProxyManager\Exception\ExceptionInterface
{
