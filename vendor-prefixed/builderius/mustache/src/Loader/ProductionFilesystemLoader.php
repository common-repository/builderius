...
use Builderius\Mustache\Source\FilesystemSource;
/**
 ...
 * {@inheritdoc}
 */
class ProductionFilesystemLoader extends \Builderius\Mustache\Loader\FilesystemLoader
{
    private $statProps;
    /**
    ...
    protected function loadFile($name)
    {
        ...
        return new \Builderius\Mustache\Source\FilesystemSource($fileName, $this->statProps);
    }
}
