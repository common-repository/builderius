...
abstract class AbstractDatabase implements \Iterator, \Countable
{
     ...
     * @psalm-pure
     */
    public static abstract function getISONumber() : string;
    /**
     * @param array<string, string> $entry
     *
     * @return object
     */
    protected abstract function arrayToEntry(array $entry);
    /**
    ...
    private function loadClusterIndex() : void
    {
        ...
        $json = \json_decode(\file_get_contents($databaseFilePath), \true);
