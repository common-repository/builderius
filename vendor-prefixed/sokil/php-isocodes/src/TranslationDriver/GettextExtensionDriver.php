...
class GettextExtensionDriver implements \Builderius\Sokil\IsoCodes\TranslationDriver\TranslationDriverInterface
{
    public function configureDirectory(string $isoNumber, string $directory) : void
    {
        // add gettext domain
        \bindtextdomain($isoNumber, $directory);
        \bind_textdomain_codeset($isoNumber, 'UTF-8');
    }
    /**
