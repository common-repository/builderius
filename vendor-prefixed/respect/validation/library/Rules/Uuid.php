 ...
 */
final class Uuid extends \Builderius\Respect\Validation\Rules\AbstractRule
{
    /**
    ...
    public function __construct(?int $version = null)
    {
        if ($version !== null && !$this->isSupportedVersion($version)) {
            throw new \Builderius\Respect\Validation\Exceptions\ComponentException(\sprintf('Only versions 1, 3, 4, and 5 are supported: %d given', $version));
        }
