 ...
 */
final class Call extends \Builderius\Respect\Validation\Rules\AbstractRule
{
    /**
     * @var callable
     */
     ...
     */
    public function __construct(callable $callable, \Builderius\Respect\Validation\Validatable $rule)
    {
