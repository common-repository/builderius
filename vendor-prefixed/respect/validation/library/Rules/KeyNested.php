 ...
 */
final class KeyNested extends \Builderius\Respect\Validation\Rules\AbstractRelated
{
    /**
     * {@inheritDoc}
     */
    public function hasReference($input) : bool
    {
        ...
        } catch (\Builderius\Respect\Validation\Exceptions\ComponentException $cex) {
            return \false;
        }
        return \true;
    }
    ...
    public function getReferenceValue($input)
    {
        if (\is_scalar($input)) {
            ...
            throw new \Builderius\Respect\Validation\Exceptions\ComponentException($message);
        }
