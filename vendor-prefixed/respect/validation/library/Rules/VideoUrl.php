 ...
 */
final class VideoUrl extends \Builderius\Respect\Validation\Rules\AbstractRule
{
    ...
    public function __construct(?string $service = null)
    {
        if ($service !== null && !$this->isSupportedService($service)) {
            throw new \Builderius\Respect\Validation\Exceptions\ComponentException(\sprintf('"%s" is not a recognized video service.', $service));
        }
