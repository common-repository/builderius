 ...
 */
final class Base extends \Builderius\Respect\Validation\Rules\AbstractRule
{
    /**
     * @var string
     */
    ...
    public function __construct(int $base, ?string $chars = null)
    {
        ...
        if ($base > $max) {
            throw new \Builderius\Respect\Validation\Exceptions\ComponentException(\sprintf('a base between 1 and %s is required', $max));
        }
        $this->base = $base;
    }
    /**
