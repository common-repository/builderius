 ...
 */
final class Key extends \Builderius\Respect\Validation\Rules\AbstractRelated
{
    /**
    ...
    public function __construct($reference, ?\Builderius\Respect\Validation\Validatable $rule = null, bool $mandatory = \true)
    {
        if (!\is_scalar($reference) || $reference === '') {
            throw new \Builderius\Respect\Validation\Exceptions\ComponentException('Invalid array key name');
        }
