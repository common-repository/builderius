 ...
 */
abstract class AbstractEnvelope extends \Builderius\Respect\Validation\Rules\AbstractRule
{
    /**
     * @var Validatable
     */
     ...
     */
    public function __construct(\Builderius\Respect\Validation\Validatable $validatable, array $parameters = [])
    {
     ...
     * {@inheritDoc}
     */
    public function reportError($input, array $extraParameters = []) : \Builderius\Respect\Validation\Exceptions\ValidationException
    {
