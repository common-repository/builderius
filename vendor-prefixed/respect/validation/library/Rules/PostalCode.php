 ...
 */
final class PostalCode extends \Builderius\Respect\Validation\Rules\AbstractEnvelope
{
    ...
    {
        $countryCodeRule = new \Builderius\Respect\Validation\Rules\CountryCode();
        if (!$countryCodeRule->validate($countryCode)) {
            throw new \Builderius\Respect\Validation\Exceptions\ComponentException(\sprintf('Cannot validate postal code from "%s" country', $countryCode));
        }
        parent::__construct(new \Builderius\Respect\Validation\Rules\Regex(self::POSTAL_CODES[$countryCode] ?? self::DEFAULT_PATTERN), ['countryCode' => $countryCode]);
    }
}
