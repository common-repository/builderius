 ...
 */
final class Attribute extends \Builderius\Respect\Validation\Rules\AbstractRelated
{
    public function __construct(string $reference, ?\Builderius\Respect\Validation\Validatable $rule = null, bool $mandatory = \true)
    {
