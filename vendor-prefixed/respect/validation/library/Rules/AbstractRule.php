 ...
 */
abstract class AbstractRule implements \Builderius\Respect\Validation\Validatable
{
    /**
     * @var string|null
     */
    ...
    {
        return \Builderius\Respect\Validation\Factory::getDefaultInstance()->exception($this, $input, $extraParams);
    }
    /**
     * {@inheritDoc}
     */
     ...
     * {@inheritDoc}
     */
    public function setTemplate(string $template) : \Builderius\Respect\Validation\Validatable
    {
