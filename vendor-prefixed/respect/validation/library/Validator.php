...
use Builderius\Respect\Validation\Rules\AllOf;
use function count;
/**
 ...
 */
final class Validator extends \Builderius\Respect\Validation\Rules\AllOf
{
    /**
    ...
    {
        $this->addRule(\Builderius\Respect\Validation\Factory::getDefaultInstance()->rule($ruleName, $arguments));
        return $this;
    }
}
