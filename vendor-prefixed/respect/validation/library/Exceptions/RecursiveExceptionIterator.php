...
final class RecursiveExceptionIterator implements \RecursiveIterator, \Countable
{
     ...
     */
    private $exceptions;
    public function __construct(\Builderius\Respect\Validation\Exceptions\NestedValidationException $parent)
    {
    ...
    public function hasChildren() : bool
    {
        ...
        return $this->current() instanceof \Builderius\Respect\Validation\Exceptions\NestedValidationException;
    }
     ...
     */
    public function current() : \Builderius\Respect\Validation\Exceptions\ValidationException
    {
