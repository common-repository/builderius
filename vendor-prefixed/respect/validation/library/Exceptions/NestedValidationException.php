 ...
 */
class NestedValidationException extends \Builderius\Respect\Validation\Exceptions\ValidationException implements \IteratorAggregate
{
    /**
     ...
     */
    public function addChild(\Builderius\Respect\Validation\Exceptions\ValidationException $exception) : self
    {
    ...
    {
        return new \RecursiveIteratorIterator(new \Builderius\Respect\Validation\Exceptions\RecursiveExceptionIterator($this), \RecursiveIteratorIterator::SELF_FIRST);
    }
    private function isOmissible(\Builderius\Respect\Validation\Exceptions\Exception $exception) : bool
    {
        if (!$exception instanceof self) {
            return \false;
        }
        ...
        return !$childException instanceof \Builderius\Respect\Validation\Exceptions\NonOmissibleException;
    }
    /**
     * @param string[]|string[][] $templates
     */
    private function renderMessage(\Builderius\Respect\Validation\Exceptions\ValidationException $exception, array $templates) : string
    {
