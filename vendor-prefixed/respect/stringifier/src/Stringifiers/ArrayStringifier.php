 ...
 */
final class ArrayStringifier implements \Builderius\Respect\Stringifier\Stringifier
{
    /**
     * @var Stringifier
     */
     ...
     */
    public function __construct(\Builderius\Respect\Stringifier\Stringifier $stringifier, \Builderius\Respect\Stringifier\Quoter $quoter, int $maximumDepth, int $itemsLimit)
    {
