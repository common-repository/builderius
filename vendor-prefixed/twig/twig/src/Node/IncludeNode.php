 ...
 */
class IncludeNode extends \Builderius\Twig\Node\Node implements \Builderius\Twig\Node\NodeOutputInterface
{
    public function __construct(\Builderius\Twig\Node\Expression\AbstractExpression $expr, ?\Builderius\Twig\Node\Expression\AbstractExpression $variables, bool $only, bool $ignoreMissing, int $lineno, string $tag = null)
    {
        $nodes = ['expr' => $expr];
        if (null !== $variables) {
    ...
    protected function addGetTemplate(\Builderius\Twig\Compiler $compiler)
    {
    ...
    protected function addTemplateArguments(\Builderius\Twig\Compiler $compiler)
    {
