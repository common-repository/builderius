 ...
 */
class SetNode extends \Builderius\Twig\Node\Node implements \Builderius\Twig\Node\NodeCaptureInterface
{
    public function __construct(bool $capture, \Builderius\Twig\Node\Node $names, \Builderius\Twig\Node\Node $values, int $lineno, string $tag = null)
    {
        ...
        if ($this->getAttribute('capture')) {
            ...
            if ($values instanceof \Builderius\Twig\Node\TextNode) {
                $this->setNode('values', new \Builderius\Twig\Node\Expression\ConstantExpression($values->getAttribute('data'), $values->getTemplateLine()));
