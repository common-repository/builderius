 ...
 */
class ForNode extends \Builderius\Twig\Node\Node
{
    private $loop;
    public function __construct(\Builderius\Twig\Node\Expression\AssignNameExpression $keyTarget, \Builderius\Twig\Node\Expression\AssignNameExpression $valueTarget, \Builderius\Twig\Node\Expression\AbstractExpression $seq, ?\Builderius\Twig\Node\Node $ifexpr, \Builderius\Twig\Node\Node $body, ?\Builderius\Twig\Node\Node $else, int $lineno, string $tag = null)
    {
        $body = new \Builderius\Twig\Node\Node([$body, $this->loop = new \Builderius\Twig\Node\ForLoopNode($lineno, $tag)]);
