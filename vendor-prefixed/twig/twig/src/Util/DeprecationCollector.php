 ...
 */
namespace Builderius\Twig\Util;
...
final class DeprecationCollector
{
    ...
    public function collectDir(string $dir, string $ext = '.twig') : array
    {
        ...
        return $this->collect(new \Builderius\Twig\Util\TemplateDirIterator($iterator));
    }
    /**
    ...
    public function collect(\Traversable $iterator) : array
    {
        ...
        foreach ($iterator as $name => $contents) {
            try {
                $this->twig->parse($this->twig->tokenize(new \Builderius\Twig\Source($contents, $name)));
