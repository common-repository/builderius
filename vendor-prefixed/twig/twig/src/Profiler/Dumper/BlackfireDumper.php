...
EOF;
    ...
    private function dumpChildren(string $parent, \Builderius\Twig\Profiler\Profile $profile, &$data)
    {
    ...
    private function dumpProfile(string $edge, \Builderius\Twig\Profiler\Profile $profile, &$data)
    {
        if (isset($data[$edge])) {
            ++$data[$edge]['ct'];
