...
abstract class Template
{
    ...
    public function getParent(array $context)
    {
        ...
        try {
            ...
            if ($parent instanceof self || $parent instanceof \Builderius\Twig\TemplateWrapper) {
    ...
    public function displayParentBlock($name, array $context, array $blocks = [])
    {
        if (isset($this->traits[$name])) {
            ...
            throw new \Builderius\Twig\Error\RuntimeError(\sprintf('The template has no parent and no traits defining the "%s" block.', $name), -1, $this->getSourceContext());
        }
    }
    /**
     * Displays a block.
    ...
    public function displayBlock($name, array $context, array $blocks = [], $useBlocks = \true, self $templateContext = null)
    {
        ...
        if (null !== $template) {
            try {
                ...
                $e = new \Builderius\Twig\Error\RuntimeError(\sprintf('An exception has been thrown during the rendering of a template ("%s").', $e->getMessage()), -1, $template->getSourceContext(), $e);
                $e->guess();
                throw $e;
            }
        } elseif (\false !== ($parent = $this->getParent($context))) {
            ...
            throw new \Builderius\Twig\Error\RuntimeError(\sprintf('Block "%s" should not call parent() in "%s" as the block does not exist in the parent template "%s".', $name, $blocks[$name][0]->getTemplateName(), $this->getTemplateName()), -1, $blocks[$name][0]->getSourceContext());
        } else {
            throw new \Builderius\Twig\Error\RuntimeError(\sprintf('Block "%s" on template "%s" does not exist.', $name, $this->getTemplateName()), -1, ($templateContext ?? $this)->getSourceContext());
        }
    }
    /**
    ...
    protected function loadTemplate($template, $templateName = null, $line = null, $index = null)
    {
        try {
            ...
            if ($template instanceof self || $template instanceof \Builderius\Twig\TemplateWrapper) {
                return $template;
            }
            ...
            if (!$e->getSourceContext()) {
                $e->setSourceContext($templateName ? new \Builderius\Twig\Source('', $templateName) : $this->getSourceContext());
            }
    ...
    protected function displayWithErrorHandling(array $context, array $blocks = [])
    {
        try {
            ...
            $e = new \Builderius\Twig\Error\RuntimeError(\sprintf('An exception has been thrown during the rendering of a template ("%s").', $e->getMessage()), -1, $this->getSourceContext(), $e);
            $e->guess();
            throw $e;
        }
    }
