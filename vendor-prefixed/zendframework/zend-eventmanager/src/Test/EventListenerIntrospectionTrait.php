 ...
 */
namespace Builderius\Zend\EventManager\Test;
...
trait EventListenerIntrospectionTrait
{
     ...
     * @return string[]
     */
    private function getEventsFromEventManager(\Builderius\Zend\EventManager\EventManager $events)
    {
     ...
     * @return \Traversable
     */
    private function getListenersForEvent($event, \Builderius\Zend\EventManager\EventManager $events, $withPriority = \false)
    {
        $r = new \ReflectionProperty($events, 'events');
        $r->setAccessible(\true);
     ...
     */
    private function assertListenerAtPriority(callable $expectedListener, $expectedPriority, $event, \Builderius\Zend\EventManager\EventManager $events, $message = '')
    {
     ...
     * @return callable[]
     */
    private function getArrayOfListenersForEvent($event, \Builderius\Zend\EventManager\EventManager $events)
    {
