...
use function substr;
class ClassGenerator extends \Builderius\Zend\Code\Generator\AbstractGenerator implements \Builderius\Zend\Code\Generator\TraitUsageInterface
{
    ...
    {
        $this->traitUsageGenerator = new \Builderius\Zend\Code\Generator\TraitUsageGenerator($this);
        if ($name !== null) {
            $this->setName($name);
        }
     ...
     * @return self
     */
    public function setContainingFileGenerator(\Builderius\Zend\Code\Generator\FileGenerator $fileGenerator)
    {
     ...
     * @return self
     */
    public function setDocBlock(\Builderius\Zend\Code\Generator\DocBlockGenerator $docBlock)
    {
    ...
    public function setImplementedInterfaces(array $implementedInterfaces)
    {
        \array_map(function ($implementedInterface) {
            return (string) \Builderius\Zend\Code\Generator\TypeGenerator::fromTypeString($implementedInterface);
    ...
    {
        $implementedInterface = (string) \Builderius\Zend\Code\Generator\TypeGenerator::fromTypeString($implementedInterface);
     ...
     * @return self
     */
    public function addConstantFromGenerator(\Builderius\Zend\Code\Generator\PropertyGenerator $constant)
    {
        $constantName = $constant->getName();
        if (isset($this->constants[$constantName])) {
            throw new \Builderius\Zend\Code\Generator\Exception\InvalidArgumentException(\sprintf('A constant by name %s already exists in this class.', $constantName));
        }
        if (!$constant->isConst()) {
            throw new \Builderius\Zend\Code\Generator\Exception\InvalidArgumentException(\sprintf('The value %s is not defined as a constant.', $constantName));
        }
    ...
    public function addConstant($name, $value)
    {
        if (empty($name) || !\is_string($name)) {
            throw new \Builderius\Zend\Code\Generator\Exception\InvalidArgumentException(\sprintf('%s expects string for name', __METHOD__));
        }
        $this->validateConstantValue($value);
        return $this->addConstantFromGenerator(new \Builderius\Zend\Code\Generator\PropertyGenerator($name, new \Builderius\Zend\Code\Generator\PropertyValueGenerator($value), \Builderius\Zend\Code\Generator\PropertyGenerator::FLAG_CONSTANT));
    }
    /**
    ...
    public function addConstants(array $constants)
    {
        foreach ($constants as $constant) {
            if ($constant instanceof \Builderius\Zend\Code\Generator\PropertyGenerator) {
    ...
    public function addProperties(array $properties)
    {
        foreach ($properties as $property) {
            if ($property instanceof \Builderius\Zend\Code\Generator\PropertyGenerator) {
     ...
     * @return self
     */
    public function addProperty($name, $defaultValue = null, $flags = \Builderius\Zend\Code\Generator\PropertyGenerator::FLAG_PUBLIC)
    {
        if (!\is_string($name)) {
            throw new \Builderius\Zend\Code\Generator\Exception\InvalidArgumentException(\sprintf('%s::%s expects string for name', \get_class($this), __FUNCTION__));
        }
        // backwards compatibility
        // @todo remove this on next major version
        if ($flags === \Builderius\Zend\Code\Generator\PropertyGenerator::FLAG_CONSTANT) {
            return $this->addConstant($name, $defaultValue);
        }
        return $this->addPropertyFromGenerator(new \Builderius\Zend\Code\Generator\PropertyGenerator($name, $defaultValue, $flags));
    }
    /**
    ...
    public function addPropertyFromGenerator(\Builderius\Zend\Code\Generator\PropertyGenerator $property)
    {
        ...
        if (isset($this->properties[$propertyName])) {
            throw new \Builderius\Zend\Code\Generator\Exception\InvalidArgumentException(\sprintf('A property by name %s already exists in this class.', $propertyName));
        }
        // backwards compatibility
        // @todo remove this on next major version
        if ($property->isConst()) {
    ...
    public function addMethods(array $methods)
    {
        foreach ($methods as $method) {
            if ($method instanceof \Builderius\Zend\Code\Generator\MethodGenerator) {
     ...
     * @return self
     */
    public function addMethod($name, array $parameters = [], $flags = \Builderius\Zend\Code\Generator\MethodGenerator::FLAG_PUBLIC, $body = null, $docBlock = null)
    {
        if (!\is_string($name)) {
            throw new \Builderius\Zend\Code\Generator\Exception\InvalidArgumentException(\sprintf('%s::%s expects string for name', \get_class($this), __FUNCTION__));
        }
        return $this->addMethodFromGenerator(new \Builderius\Zend\Code\Generator\MethodGenerator($name, $parameters, $flags, $body, $docBlock));
    }
    /**
    ...
    public function addMethodFromGenerator(\Builderius\Zend\Code\Generator\MethodGenerator $method)
    {
        ...
        if ($this->hasMethod($methodName)) {
            throw new \Builderius\Zend\Code\Generator\Exception\InvalidArgumentException(\sprintf('A method by name %s already exists in this class.', $methodName));
        }
    ...
    private function validateConstantValue($value)
    {
        ...
        throw new \Builderius\Zend\Code\Generator\Exception\InvalidArgumentException(\sprintf('Expected value for constant, value must be a "scalar" or "null", "%s" found', \gettype($value)));
    }
    /**
