...
class ParameterGenerator extends \Builderius\Zend\Code\Generator\AbstractGenerator
{
    /**
     * @var string
     */
     ...
     */
    public static function fromReflection(\Builderius\Zend\Code\Reflection\ParameterReflection $reflectionParameter)
    {
        $param = new \Builderius\Zend\Code\Generator\ParameterGenerator();
    ...
    {
        if (!isset($array['name'])) {
            throw new \Builderius\Zend\Code\Generator\Exception\InvalidArgumentException('Parameter generator requires that a name is provided for this object');
        }
    ...
    {
        $this->type = \Builderius\Zend\Code\Generator\TypeGenerator::fromTypeString($type);
        return $this;
    }
    /**
     * @return string
    ...
    {
        if (!$defaultValue instanceof \Builderius\Zend\Code\Generator\ValueGenerator) {
            $defaultValue = new \Builderius\Zend\Code\Generator\ValueGenerator($defaultValue);
        }
    ...
    public function generate()
    {
        ...
        if ($this->defaultValue instanceof \Builderius\Zend\Code\Generator\ValueGenerator) {
            $output .= ' = ';
            $this->defaultValue->setOutputMode(\Builderius\Zend\Code\Generator\ValueGenerator::OUTPUT_SINGLE_LINE);
     ...
     * @return null|string
     */
    private static function extractFQCNTypeFromReflectionType(\Builderius\Zend\Code\Reflection\ParameterReflection $reflectionParameter)
    {
     ...
     * @return string|null
     */
    private static function prePhp7ExtractFQCNTypeFromReflectionType(\Builderius\Zend\Code\Reflection\ParameterReflection $reflectionParameter)
    {
