 ...
 */
namespace Builderius\Zend\Code\Annotation;

use Builderius\Zend\Code\Annotation\Parser\ParserInterface;
use Builderius\Zend\EventManager\Event;
use Builderius\Zend\EventManager\EventManager;
use Builderius\Zend\EventManager\EventManagerAwareInterface;
use Builderius\Zend\EventManager\EventManagerInterface;
 ...
 */
class AnnotationManager implements \Builderius\Zend\EventManager\EventManagerAwareInterface
{
     ...
     */
    public function setEventManager(\Builderius\Zend\EventManager\EventManagerInterface $events)
    {
    ...
    {
        if (null === $this->events) {
            $this->setEventManager(new \Builderius\Zend\EventManager\EventManager());
        }
        return $this->events;
    }
    /**
     ...
     * @return AnnotationManager
     */
    public function attach(\Builderius\Zend\Code\Annotation\Parser\ParserInterface $parser)
    {
    ...
    {
        $event = new \Builderius\Zend\EventManager\Event();
