...
use Builderius\Doctrine\Common\Annotations\AnnotationRegistry;
use Builderius\Doctrine\Common\Annotations\DocParser;
use Traversable;
 ...
 */
class DoctrineAnnotationParser implements \Builderius\Zend\Code\Annotation\Parser\ParserInterface
{
    /**
    ...
    public function __construct()
    {
        ...
        \Builderius\Doctrine\Common\Annotations\AnnotationRegistry::registerLoader(function ($class) {
     ...
     */
    public function setDocParser(\Builderius\Doctrine\Common\Annotations\DocParser $docParser)
    {
    ...
    {
        if (!$this->docParser instanceof \Builderius\Doctrine\Common\Annotations\DocParser) {
            $this->setDocParser(new \Builderius\Doctrine\Common\Annotations\DocParser());
        }
