...
class CachingFileScanner extends \Builderius\Zend\Code\Scanner\FileScanner
{
    /**
     * @var array
     */
    ...
    public function __construct($file, \Builderius\Zend\Code\Annotation\AnnotationManager $annotationManager = null)
    {
        ...
        if (isset(static::$cache[$cacheId])) {
            ...
            $this->fileScanner = new \Builderius\Zend\Code\Scanner\FileScanner($file, $annotationManager);
