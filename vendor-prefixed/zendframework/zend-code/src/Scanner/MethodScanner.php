...
class MethodScanner implements \Builderius\Zend\Code\Scanner\ScannerInterface
{
    /**
     * @var bool
     */
     ...
     */
    public function __construct(array $methodTokens, \Builderius\Zend\Code\NameInformation $nameInformation = null)
    {
     ...
     * @return MethodScanner
     */
    public function setScannerClass(\Builderius\Zend\Code\Scanner\ClassScanner $scannerClass)
    {
    ...
    public function setVisibility($visibility)
    {
        switch ($visibility) {
            ...
            case \T_PROTECTED:
                ...
                break;
            default:
                throw new \Builderius\Zend\Code\Exception\InvalidArgumentException('Invalid visibility argument passed to setVisibility.');
        }
        return $this;
    }
    /**
    ...
    public function getParameter($parameterNameOrInfoIndex)
    {
        ...
        if (\is_int($parameterNameOrInfoIndex)) {
            ...
            if ($info['type'] != 'parameter') {
                throw new \Builderius\Zend\Code\Exception\InvalidArgumentException('Index of info offset is not about a parameter');
            }
        ...
        $p = new \Builderius\Zend\Code\Scanner\ParameterScanner(\array_slice($this->tokens, $info['tokenStart'], $info['tokenEnd'] - $info['tokenStart']), $this->nameInformation);
