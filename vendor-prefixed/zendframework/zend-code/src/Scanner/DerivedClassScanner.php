...
class DerivedClassScanner extends \Builderius\Zend\Code\Scanner\ClassScanner
{
    /**
     ...
     */
    public function __construct(\Builderius\Zend\Code\Scanner\ClassScanner $classScanner, \Builderius\Zend\Code\Scanner\DirectoryScanner $directoryScanner)
    {
    ...
    public function getConstant($constantNameOrInfoIndex)
    {
        ...
        throw new \Builderius\Zend\Code\Exception\InvalidArgumentException(\sprintf('Constant %s not found in %s', $constantNameOrInfoIndex, $this->classScanner->getName()));
    }
    /**
    ...
    public function getProperty($propertyNameOrInfoIndex)
    {
        ...
        throw new \Builderius\Zend\Code\Exception\InvalidArgumentException(\sprintf('Property %s not found in %s', $propertyNameOrInfoIndex, $this->classScanner->getName()));
    }
    /**
    ...
    public function getMethod($methodNameOrInfoIndex)
    {
        ...
        throw new \Builderius\Zend\Code\Exception\InvalidArgumentException(\sprintf('Method %s not found in %s', $methodNameOrInfoIndex, $this->classScanner->getName()));
    }
    /**
