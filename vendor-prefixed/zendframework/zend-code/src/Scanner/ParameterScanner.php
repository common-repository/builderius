...
class ParameterScanner
{
     ...
     */
    public function __construct(array $parameterTokens, \Builderius\Zend\Code\NameInformation $nameInformation = null)
    {
     ...
     * @return void
     */
    public function setDeclaringScannerClass(\Builderius\Zend\Code\Scanner\ClassScanner $scannerClass)
    {
     ...
     * @return void
     */
    public function setDeclaringScannerFunction(\Builderius\Zend\Code\Scanner\MethodScanner $scannerFunction)
    {
    ...
    protected function scan()
    {
        ...
        if ($this->name !== null) {
            $this->defaultValue .= \trim(\is_string($token) ? $token : $token[1]);
        }
        SCANNER_CONTINUE:
