...
use function substr;
use function trim;
class DocBlockScanner implements \Builderius\Zend\Code\Scanner\ScannerInterface
{
    /**
     * @var bool
     */
     ...
     */
    public function __construct($docComment, \Builderius\Zend\Code\NameInformation $nameInformation = null)
    {
    ...
    protected function scan()
    {
        ...
        goto SCANNER_TOP;
        SCANNER_END:
        $this->shortDescription = \trim($this->shortDescription);
        $this->longDescription = \trim($this->longDescription);
        $this->isScanned = \true;
    }
    /**
     * @return array
