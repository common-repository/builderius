...
class AnnotationScanner extends \Builderius\Zend\Code\Annotation\AnnotationCollection implements \Builderius\Zend\Code\Scanner\ScannerInterface
{
    /**
     * @var bool
     */
     ...
     */
    public function __construct(\Builderius\Zend\Code\Annotation\AnnotationManager $annotationManager, $docComment, \Builderius\Zend\Code\NameInformation $nameInformation = null)
    {
     ...
     * @param NameInformation $nameInformation
     */
    public function setNameInformation(\Builderius\Zend\Code\NameInformation $nameInformation)
    {
        $this->nameInformation = $nameInformation;
    }
    /**
