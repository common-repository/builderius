...
class AggregateDirectoryScanner extends \Builderius\Zend\Code\Scanner\DirectoryScanner
{
    /**
     * @var bool
     */
    ...
    public function getClass($class, $returnScannerClass = \true, $returnDerivedScannerClass = \false)
    {
        ...
        if (!isset($scanner)) {
            throw new \Builderius\Zend\Code\Exception\RuntimeException('Class by that name was not found.');
        }
        $classScanner = $scanner->getClass($class);
        return new \Builderius\Zend\Code\Scanner\DerivedClassScanner($classScanner, $this);
    }
    /**
     * @param bool $returnScannerClass
     */
    public function getFunctions($returnScannerClass = \false)
    {
        ...
        $scannerClass = new \Builderius\Zend\Code\Scanner\FunctionScanner();
        // @todo
    }
}
