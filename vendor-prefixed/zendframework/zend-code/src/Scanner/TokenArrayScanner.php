...
class TokenArrayScanner implements \Builderius\Zend\Code\Scanner\ScannerInterface
{
    /**
     * @var bool
     */
     ...
     */
    public function __construct($tokens, \Builderius\Zend\Code\Annotation\AnnotationManager $annotationManager = null)
    {
        $this->tokens = $tokens;
    ...
    public function getClass($name)
    {
        ...
        if (\is_int($name)) {
            ...
            if ($info['type'] != 'class') {
                throw new \Builderius\Zend\Code\Exception\InvalidArgumentException('Index of info offset is not about a class');
            }
        ...
        return new \Builderius\Zend\Code\Scanner\ClassScanner(
            \array_slice($this->tokens, $info['tokenStart'], $info['tokenEnd'] - $info['tokenStart'] + 1),
            // zero indexed array
            new \Builderius\Zend\Code\NameInformation($info['namespace'], $info['uses'])
        );
    }
    /**
    ...
    public function getClassNameInformation($className)
    {
        ...
        return new \Builderius\Zend\Code\NameInformation($info['namespace'], $info['uses']);
    }
    /**
     * @return array
     */
    ...
    protected function getUsesNoScan($namespace)
    {
        ...
        if ($namespace === null) {
            ...
            throw new \Builderius\Zend\Code\Exception\InvalidArgumentException('Invalid namespace provided');
